...
export default function Index() {
  ...
  const settingsOptions = [
    {
      ...
      title: () => <Text className="text-white text-base font-semibold">Settings</Text>,
  ...
  return (
    <View className="flex-1 bg-[#121212]">
      {/* Header Shape */}
      <View
        className="absolute bg-[#2a2b33] z-0"
        style={{
          top: 0,
          width: width,
          height: height * 0.2,
      ...
      <ScrollView contentContainerStyle={{ paddingTop: height * 0.07 }}>
        ...
        <View className="items-center mb-6">
          <View className="bg-[#1d2144] px-6 py-4 rounded-2xl items-center">
